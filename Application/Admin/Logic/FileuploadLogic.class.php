...
use Admin\Api\Fileupload;
class FileuploadLogic implements  Fileupload{
	/* !CodeTemplates.overridecomment.nonjd!
	 * @see \Admin\Api\Fileupload::fileupload()
	 */
	...
	public function fileuploader($data) {
		...
		$uploadDir = $_SERVER[DOCUMENT_ROOT] . $config['server']['uploadDir'];
