...
<link rel="stylesheet" type="text/css" href="/gonghenew/Public/Admin/css/login/style.css" />
<link rel="stylesheet" type="text/css" href="/gonghenew/Public/Admin/css/login/animate.css" />

<script type="text/javascript" src="/gonghenew/Public/Admin/js/login/login.js"></script>
<script type="text/javascript" src="/gonghenew/Public/Admin/js/login/jquery.min.js"></script>	  
<script type="text/javascript" src="/gonghenew/Public/Admin/js/plugins/layer/layer.min.js"></script>	  
...
<h2 align="center">欢迎使用投富宝后台管理系统</h2>
<div class="login_frame"></div>
<div class="LoginWindow">
	<div>
	<form action="<?php echo U('User/login');?>" method="post">
		<div class="login">
			<p><input type="text" name="username" id="name" placeholder="用户名" ></p>
			<p><input type="password" name="password" id="pass" placeholder="密码"></p>
...
<div class="box">
	<form action="<?php echo U('User/register');?>" method="post" onsubmit="return check()">
		<div class="regiest">
			<p><input type="text" id="username" name="username" placeholder="用户名(12个字符以内)"></p>
			<p><input type="text" id="nickname" name="nickname" placeholder="昵称(12个字符以内)" ></p>
			<p><input type="password" id="PWD" name="password" placeholder="密码" ></p>
...
<p><a href="http://www.toufb.com/" target="_blank">技术支持:投富宝技术组</a></p>
</div>
</body>
</html>